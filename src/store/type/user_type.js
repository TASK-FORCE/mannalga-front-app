...
export const CLEAR_SELECTED_REGIONS = 'clearSelectedRegions';
export const CLEAR_SELECTED_INTERESTS = 'clearSelectedInterest';
...
export const REQUEST_CHANGE_USER_INTEREST = 'requestChangeUserInterest';
