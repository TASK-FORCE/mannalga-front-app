<template>
    <div>
        ...
        ><!-- @click="onClickImageUpload" -->
            ...
            <!-- @TODO: upload-url 추후 -->
            <!-- 
                이미지 자르는 modal창 관련 (image-cropper) : https://github.com/overtrue/vue-avatar-cropper
                이미지 자르기 옵션 (cropper-options) : https://github.com/fengyuanchen/cropperjs#options 
